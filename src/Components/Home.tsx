      ...
      <div className="flex justify-center items-center flex-col m-auto gap-[20px] mt-[40px] max-w-[520px] md:flex-wrap md:flex-row md:max-w-[1024px] md:pb-[50px]">
        ...
        {categories.map((category, index) => {
          return (
            <div
              key={index}
              className="w-full h-[130px] border-[gray] border-[2px] flex flex-col justify-center items-center md:w-[216px] md:h-[156px] lg:w-[295px] lg:h-[130px] xl:w-[165px] xl:h-[156px]"
            >
              <img
                className="w-[32px]"
                src={category.src}
